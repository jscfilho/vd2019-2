// https://observablehq.com/@jscfilho/d3-com-crossfilter-e-leaflet@162
export default function define(runtime, observer) {
  const main = runtime.module();
  main.variable(observer()).define(["md"], function(md){return(
md`# D3 com Crossfilter e Leaflet`
)});
...
attribution: '&copy; < ahref="http://www.openstreetmap.org/">OpenStreetMap</a>contributors',
maxZoom: 17
}).addTo(mapInstance)
return mapInstance
}
...
fillColor: '#fecc5c',
fillOpacity: 0.5
}).bindPopup("Data: " + d.dtg + "<br>" + "Magnitude: " + d.magnitude)
