...
md`# Balanço econômico dos estados`
  ...
  main.variable(observer()).define(["md"], function(md){return(
md`No gráfico abaixo temos uma visão geral sobre o balanço econômico geral por estado. A cor da circunferência indica se aquele estado arrecadou mais do que gastou ou o contrário. Já o raio indica o tamanho do superavit ou do déficit.
